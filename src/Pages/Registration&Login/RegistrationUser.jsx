        ...
        if (res.data.success) {
            ...
            if (!/^(?=.*[a-z])(?!.*[A-Z])(?=.*[0-9]).{6,}$/.test(password)) {
                return (
                    Swal.fire({
                        title: 'Warning!',
                        text: 'create password by using a-z and 0-9',
                        icon: 'warning',
            ...
            const isEmailValid = (email) => {
                ...
                // Check if the email includes the domain "seu.edu.bd"
                const includesSeuDomain = email.toLowerCase().includes('@seu.edu.bd');

                return emailRegex.test(email) && includesSeuDomain;
            };
            if (!isEmailValid(email)) {
                Swal.fire({
                    title: 'Warning!',
                    text: 'Please enter a valid email address with the domain "seu.edu.bd"',
                    icon: 'warning',
                    confirmButtonText: 'Ok'
                });
                return;
    ...
    return (
        <div className="flex items-center min-h-screen w-[97%] lg:w-full mx-auto">
            ...
            <div className="flex w-full flex-col justify-between lg:flex-row-reverse my-5">
                <div className="shadow-2xl md:w-2/3 lg:w-1/3 mx-auto mt-10 lg:mt-0 p-5 rounded-lg bg-white">
